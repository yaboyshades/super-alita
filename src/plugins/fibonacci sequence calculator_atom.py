...
async def fibonacci_sequence_calculator(
    ...
    try:
        ...
        success = True
        logger.info("fibonacci sequence calculator executed successfully")

    except Exception as e:
        logger.exception("fibonacci sequence calculator execution failed")
        result = {"error": str(e)}
        success = False
    ...
    if event_bus and hasattr(event_bus, "publish"):
        try:
            tool_result = ToolResultEvent(
                source_plugin="fibonacci sequence calculator",
            ...
            logger.debug("fibonacci sequence calculator result event published")

        except Exception as e:
            logger.error(
                f"fibonacci sequence calculator failed to publish result event: {e!s}"
            )
