...
class EnhancedDeepCodeTools:
    ...
    async def generate_text2backend(
        self,
        description: str,
    ...
    async def generate_paper2code_enhanced(
        self,
        paper_content: str,
        paper_title: str = "",
...
async def deepcode_paper2code_enhanced(
    params: dict[str, Any],
) -> dict[str, Any]:
...
def register_enhanced_deepcode_tools(app):
    ...
    async def paper2code_enhanced_tool(
        params: dict[str, Any],
    ) -> dict[str, Any]:
