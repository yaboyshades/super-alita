...
class SuperAlitaLauncher:
    ...
    def load_config(self) -> dict:
        ...
        return {
            "main_server": {"port": 8080, "host": "127.0.0.1", "auto_reload": True},
            "mcp_server": {"enabled": True, "script": "mcp_server_wrapper.py"},
            "browser": {"auto_open": True, "url_path": "/", "delay": 3},
            "health_check": {
                "timeout": 30,
                "interval": 1,
                "endpoints": ["/health", "/healthz"],
            },
            "startup": {"show_banner": True, "verbose": True},
        }
