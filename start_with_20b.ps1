# Super Alita Startup Configuration for 20B Model
# Set environment variables for optimal 20B model performance

$env:LLM_MODEL = "ollama:gpt-oss:20b"
$env:OLLAMA_HOST = "http://127.0.0.1:11434"
$env:PYTHONPATH = "./src"

# Increase timeouts for large model
$env:REUG_MODEL_STREAM_TIMEOUT_S = "120.0"
$env:STARTUP_TIMEOUT = "180"

# Reduce memory pressure
$env:REUG_MAX_TOOL_CALLS = "3"
$env:OLLAMA_KEEP_ALIVE = "5m"

Write-Host "🔧 Environment configured for GPT-OSS 20B:" -ForegroundColor Cyan
Write-Host "  • Model: $($env:LLM_MODEL)" -ForegroundColor White
Write-Host "  • Timeout: $($env:REUG_MODEL_STREAM_TIMEOUT_S)s" -ForegroundColor White
Write-Host "  • Host: $($env:OLLAMA_HOST)" -ForegroundColor White

Write-Host "`n🧪 Verifying model is loaded..." -ForegroundColor Yellow
$ollamaStatus = ollama ps
if ($ollamaStatus -match "gpt-oss:20b") {
    Write-Host "✅ GPT-OSS 20B model is ready!" -ForegroundColor Green
} else {
    Write-Host "⚠️ Loading GPT-OSS 20B model..." -ForegroundColor Yellow
    ollama run gpt-oss:20b "ready"
    Write-Host "✅ Model loaded!" -ForegroundColor Green
}

Write-Host "`n🚀 Starting Super Alita with 20B model..." -ForegroundColor Green
Write-Host "⏱️ This may take up to 3 minutes for the large model..." -ForegroundColor Yellow

# Start the application
python start_super_alita.py
# SIG # Begin signature block
# MIIaSQYJKoZIhvcNAQcCoIIaOjCCGjYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC9RZwcbzvIFQP6
# 0ul/E1jvetMFMJF9vx0h3CFpnsBbk6CCFRswggHdMIIBRqADAgECAhB1LVe8LkJa
...
# MQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgVFKgdWYF5mZG6nLH4mC2
# F612U2yv1kzJHV4bH0Z+yAIwDQYJKoZIhvcNAQEBBQAEgYBy0nfpUkF0CR/2mPsx
# 2IEywppLU+0wLyvKoGj49ztWVTbUaSFlR4x39Lz7bXq1T1Y/RJbaz+S/Agt9mWmU
# 7qaaZEEe3cwKDXd1pnepDSzTHc5ERh6Sfkagt+zuQXdseY3vBsPV1uxKfKI5TQvS
# Tv2DWIzyPDU1Ym44LDHOxAYpK6GCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIB
...
# MjgyMDE2MTRaMC8GCSqGSIb3DQEJBDEiBCArHV3LF93jtQKghIGmh1VJsM4xqA6/
# 6j9/pGyNIGXykDANBgkqhkiG9w0BAQEFAASCAgC4BBJrdGdDnUsaX/LUKBEEbfr3
# qHiaTQvs5VAiyQUk8Yvf7CQdXEH1PD2U+Z7kprIflirixEKsOYDdZZpjHO+h58+n
# ddoAmWFcLR1orUyGPtYNvwP8OcqwZwTm5iA+xsWh2CZFQQRDp01UUGU0EtTw5ntT
# EfX/hEk6WcxQfyW6ima6N4mNNpKj+DYxyArlb9BcQhQzdz8YBpD/+abYiUGfmoCV
# RHBZeHkiBYaL6f9LwFPZH2tg7rptFS2UVIaVbcvAUdTteEwep1PYjjGgbLAhhJ9j
# rasMmfk4V4i8rwLxQIn62bEOSo3kzbTlXXcCvSoFhWUbPLMRqZ7SxRmuP1Rnzl9I
# HRIAwOQ5RE/SWS3qeMj0R7t79BOJ1psbGmPVEnwqA7AQWZeohEg1Q7z+omUGR0ua
# j8RGxFf9yBK3NPciJrWoxlcD6QHoI/B9D7zdr2yl/sBbgh0+hj27anvCiTGrWRM1
# 71hSHCZTxP2qUgad829Sw4luU7r7uUTjcqAP2Q2vy2t4V3Pgk6AGItpY/ixKpjCJ
# XyezjJ7tSv45tG7eqGt6IVDMGnWq16fLlAq+wFQgi1JdyetOCnf8bvz9UdBZXR7b
# Rp51AIMBXX+MFQxFPz5d+HJf9h5vtwNnl45IzBZuykUb8Nq+biAi1hc9Vksb4fTf
# fqoOZv0qTEceMkCeBA==
