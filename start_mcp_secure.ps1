# Secure Super Alita MCP Server with Bearer Token
$env:MCP_TRANSPORT = "sse"
$env:MCP_PORT = "8001"
$env:MCP_HOST = "127.0.0.1"  # Localhost only for security
$env:MCP_ALLOW_NO_AUTH = "false"
$env:MCP_ALLOWLIST = "your-secret-token-here,another-token"  # Replace with your tokens
$env:MCP_SERVER_NAME = "Super Alita MCP Server (Secure)"

Write-Host "Starting Secure Super Alita MCP Server on http://localhost:8001"
Write-Host "Requires Bearer token: your-secret-token-here"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAsWLiRkA2O6UM7
# jRl/F9n9dAT9e2Xo6bo+tgikE7gByKCCFRswggHdMIIBRqADAgECAhB1LVe8LkJa
...
# MQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgOJiBBBwsGCfjXyw11ARI
# jooOhGGq6sMlOCQ86BJwcjUwDQYJKoZIhvcNAQEBBQAEgYBfUEdNjoVwKqNjKsPh
# vqDmVtXPiGGQk6tPhOHWyWZrkxp563ZYkqktCDrUjbz/zSo5eJxVOaiWgOEK3bV3
# HQABpGTeCRtNcxvlqNGSacGaT5egIWFsFb9qe7RoTrbIbifat55P/7Qsv0R8w99B
# Nm8/u9sslxSYTJqJ1GEZHr+PaaGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIB
...
# MjgxODUwMTZaMC8GCSqGSIb3DQEJBDEiBCC2RSB5bmrFAVgurKk5JzU853xz1D4I
# RN2K4JHuYfwxGTANBgkqhkiG9w0BAQEFAASCAgDP48+ZFgEqGyUsNx7mwFbBiAoB
# I1IIiHxefyhjjlYLEpUwdlN49UtYrWURuMkbBfoVCxhvW5Yw99Jq6Qu2yPoFefVw
# 4hX3luCk4dMWtEjuVMvI1ktUR2JoXvfhHgG+4Qmdj4OnQw6s46fL/vbAnbTQ1Nny
# Uw4qMuB8s5wv+lyUqstmnub5TwAqD99O8uVVKMhBMEz4uDalhpjLWD6s1HFJreP7
# B20S74joEPeBNYvZ+Ks2cbyiEFbK56k8nS2ZkRQaYJp5Vhjkvaq5jRGtkb5d/xB8
# CIlRcrjzOIVsNyU6tonvuRjePZOKM5SKK8WmhTMPWPfQYGwat+Hg+vLmgx9uVmSO
# iC1eDVgVUS6rW1SzWFFPN8bJtl8XnFwaWjeGhm2ZAlFpf1zkcobLv60u8L/+9x0Z
# pLmmd9bzirb+pNErccnhrMSj+PYq1QgiAKNkFi+jsMQbGMvBMLfh0pHkhHJwrbYg
# Qj5GVT7h3lilCVfupGapPgefp2PWiwjNZSQuLA/d+QVepisJuPIFz4FiJfhDlFAi
# sT/9t+jmgLLPQJnTruF0bOd/H8nYXjHTeGTwNnNv9sO2dYA5FF5MFtCFzbXrSLuG
# cqGnDWejSQxTwXRdEdhkUjqDez4cToHRvOKtnShldq87isipPRUBKN68yHR2kiMr
# zuE+R+VXuU3FmsQsHw==
