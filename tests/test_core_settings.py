...
def test_compute_retry_schedule_basic() -> None:
    result = settings.compute_retry_schedule(3, 0.5, multiplier=2.0, jitter_ratio=0.0)
...
def test_retry_schedule_respects_environment(monkeypatch: pytest.MonkeyPatch) -> None:
