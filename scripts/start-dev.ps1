# Cross-platform development server startup script for PowerShell
# Works on Windows PowerShell, PowerShell Core, and pwsh
...
Write-Host "🚀 Starting Super Alita Development Environment" -ForegroundColor Cyan
...
try {
    ...
    if (!$SkipDeps) {
        ...
        try {
            python -m pip install -r requirements.txt -r requirements-test.txt | Out-Null
            Write-Success "Dependencies installed"
        } catch {
            Write-Warning "Dependency installation had issues, continuing..."
        }
    }

    # Start the development server
    Write-Status "Starting Super Alita server on http://${ServerHost}:${Port}"
    Write-Warning "Use Ctrl+C to stop the server"
    Write-Host ""

    # Source Copilot helpers if available
    if (Test-Path "scripts\copilot-helpers.ps1") {
        Write-Status "Loading Copilot helpers..."
...
print('🎯 Super Alita server starting...')
uvicorn.run(app, host='$ServerHost', port=$Port, log_level='info', reload=True)
"

} catch {
    Write-Error "Failed to start development environment: $_"
    Write-Host "💡 Try using GitHub Copilot CLI for help: ghcs 'fix Super Alita startup error'" -ForegroundColor Magenta
    exit 1
}
# SIG # Begin signature block
# MIIaSQYJKoZIhvcNAQcCoIIaOjCCGjYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAtJ+ZrtLt+/BDb
# PGfRRGPk9HHXRwNQmF1h5k+YrKSUpaCCFRswggHdMIIBRqADAgECAhB1LVe8LkJa
...
# MQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg+LH5VwkS2B9w8yT485NW
# xjR2c7gtdM0pUji9gcZt7vowDQYJKoZIhvcNAQEBBQAEgYCDFtdgfYTqekaoNmWa
# 3l9nrYMXxThHp7iVuwhNXnAt3ykQOoma4RmpkaEnmrU+SotGWnNxNVlKYPDx3Jk9
# cqpI312YhbkJw1wrDbh5TWphtuZlAaRjpzHnmjuwKRWTjZ0u4hyG7SmT1edVEPDW
# G55bpdSssw5uHKOIeFKyM7ToC6GCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIB
...
# MjgwNTI3MzZaMC8GCSqGSIb3DQEJBDEiBCDEZkP5nGv3k59bcNS+L4tT0oo7NgCg
# tNmSg038dBWDOjANBgkqhkiG9w0BAQEFAASCAgC6Ne55bD5g8/vScEOJsdZt3od+
# Y7TDtuZ9BQDaONgCaU8QIhMKNIeZpneviSwUt/bmp0WGIp2xLSj4hsrPs71LuqKw
# vQBCRWiKQnj7Bh+JoosjFrRM2H9yRM+eW3C8yR7lr3b6H83kGBJpXY6NVL6sPHJa
# L8pxIrR6vg6EBlvlSaAeexotn64DLpm4y5mEzS4uDezuLlQvcI0joivzEvyzWdB9
# bgM6CRjMVKWSxhDAj82uYzMVJYlBOsGnTBQCPnLR63uKIW6HgizGNZHY9HpQIrps
# l116GhBHuA7okyYub1YZUvR2zc8B91BXVZcMiilgGEon+dftZPyN6bllZhZA0suz
# OQnZF1umR6YuNfM27QglybvcCamnhcIyCRFx8tLlVrO7YHEh2gPA58E+HJbCU4UR
# Vn9tNP0ZYrZ5TragRfcwfiHjNRW1DFeZF+0Iv/oADXmh8JRC3SvnwGsSWg1ZdeNZ
# 3KojY/dVvJkWsxzb/AckbBwYYYFp/ERzGy74jhb1/A6Loun6u1hQaVvEx4Cj815D
# yoycRAQrQyQHvgKGhl1wH7uI61fwjh620eGnK9tdYpR+WY0+kDRtfDKc5yJSu0Hb
# UFzXy19DCnzywC4biWaaKEKCclspIpaGRbH1bs3FQvfJS8TOBZWDH+D+KJdQBB+Y
# 3VFx+tOn0G7t2zDryQ==
