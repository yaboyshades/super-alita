...
def fix_uvicorn_config():
    ...
    config_files = ["uvicorn.json", "server.json", ".uvicorn.json"]
    ...
    print(
        "uvicorn app:app --host 127.0.0.1 --port 8080 --reload --timeout-keep-alive 120"
    )
...
def check_app_config():
    ...
    if app_py.exists():
        ...
        streaming_configs = ["timeout", "keep_alive", "lifespan", "chunk"]
