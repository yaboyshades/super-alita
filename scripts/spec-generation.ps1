function New-FeatureSpecification {
    param(
    ...
    $FeatureNumber = (Get-ChildItem $SpecsPath -Directory | Measure-Object).Count + 1
    $FeatureDir = "{0:D3}-{1}" -f $FeatureNumber, $FeatureName.ToLower().Replace(' ', '-')
    $FeaturePath = Join-Path $SpecsPath $FeatureDir
    New-Item -ItemType Directory -Path $FeaturePath -Force
    $ConstitutionContext = Get-Content "memory/constitution.md" -Raw
    $SpecTemplate = Get-Content "templates/spec-template.md" -Raw
    $AIContext = @"
...
Generate a detailed specification following the template structure.
Focus on WHAT and WHY, not HOW. Be specific about acceptance criteria.
"@
    $Specification = $SpecTemplate -replace '\[.*?\]', $RequirementsPrompt
    $SpecPath = Join-Path $FeaturePath "spec.md"
    Set-Content -Path $SpecPath -Value $Specification
    $BranchName = $FeatureDir
    git checkout -b $BranchName
    git add $FeaturePath
    git commit -m "feat: add specification for $FeatureName"
    Write-Host "✅ Specification created: $SpecPath"
    Write-Host "🌿 Feature branch created: $BranchName"
}

# SIG # Begin signature block
# MIIaSQYJKoZIhvcNAQcCoIIaOjCCGjYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBkvAgUWokdwvza
# 49losCJqU46LzsJ3Zm/0tCwRakxtWqCCFRswggHdMIIBRqADAgECAhB1LVe8LkJa
...
# MQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgk6mtnV3NMH1+1HMIZsuV
# uqJ+wccRmetlLgFwzCNt31MwDQYJKoZIhvcNAQEBBQAEgYA/qan2tzvtTDxdc0E7
# fYAB5hs6W09pO5S5H3Bz0Azi7Bo4ix7XPuOW3yKDCNqmh3SNkB6a7I0daVkofL61
# unmx1w6WjTOUdZGZkTaAkIKKW+6ad855oQFZBgsbtQEco4EO2cDOARA5bZEX16wj
# xmUVP/66zp8N4+q0wrtbUEysnqGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIB
...
# MjEwNzMzMDFaMC8GCSqGSIb3DQEJBDEiBCAK6Jgw2mleTtKwbGpXIVgPty76E/b3
# /KIfA2PBisgbijANBgkqhkiG9w0BAQEFAASCAgC2vfceOJoSicRm81BqA6SRu0s+
# mkdNCQOnXXrxzgxPCIaTsPnsK0/zS0zDvU06q9nEzQjZZ7gGROWrjAxeRXZ9jPWs
# kpOzfz7Zov8DNITyj0bOZIwRNR5nhb3j+1UHqRypfhS57DjI9XXmkv+gkX55MwFZ
# hWumlTbiCeLPMKOh/PqL1XePwZbtRYZP4C7XCgK7Q2SHBTh4mpIu7lyguYF3B1qy
# IVFfxIqZluz0shFhgOHtnHst9K1MaGovHurVvKEi4j4WeglLDE25X3RXeOJPpXp3
# id1KQWY4lN0YhFSqFQMmkghV7degN29abAAiz0eqABw8w/wUhxLUe8r7LMotAFIq
# H9vwKtb/MjSDnedIfe5hp6YjXzTViPklgiq/w2gDSdHZyKlq957QxpKKcV8M7iSt
# 52HX5nfh7THWVSUM5WE9CqRZ9To64tG0JzTDsJODGnEJl2lZDuaout0D39s6jV/a
# /phgTpkXCj7HVl8C2gNzDB+swnRTvHOskKeO7KCfje1bOgHe6WG+Fcwpmy3VtMH/
# H8ANiCEG+AhoiTZTecGokGgnJEYLh4l6lolSYRagp40ldHZKwa+ZelZMDSN3gvHj
# okpam/RUZygi8Xitl2VpAitLYVG4AD2GWTiaewcK+XELZ4ftAuXiGbdxA6WQ9agv
# kAIGrfa9KrOV6/mIwg==
