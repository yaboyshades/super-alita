...
### Templates
- `templates/sdd/spec-template.md` - Specification phase template
- `templates/sdd/plan-template.md` - Planning phase template
- `templates/sdd/tasks-template.md` - Task breakdown phase template
