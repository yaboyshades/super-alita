...
from src.main import SimpleAbilityRegistry  # noqa: E402
from src.orchestration.unified_orchestrator import (  # noqa: E402
    UnifiedOrchestrator,
    UnifiedRunConfig,
)
...
async def demo_sdd_workflow():
    ...
    ability_registry.register_tool(
        contract={
            "tool_id": "sdd_specify",
            "description": "SDD specification generation with constitutional validation",  # noqa: E501
            "input_schema": {
                "type": "object",
    ...
    config = UnifiedRunConfig(
        prompt="Build a production-ready web scraper following constitutional principles",  # noqa: E501
        run_id="demo-sdd-001",
    ...
    for stage_name, stage_data in stages.items():
        if stage_data.get("status") == "success":
            ...
            if "constitutional_score" in output:
                ...
                threshold = config.constitutional_threshold
...
async def demo_streaming_orchestration():
    ...
    config = UnifiedRunConfig(
        prompt="Design and implement a machine learning model for text classification",  # noqa: E501
    ...
    event_types = {e.get("type", "Unknown") for e in events_captured}
...
async def demo_error_handling():
    ...
    async def failing_ability(args):
        msg = "Simulated constitutional violation - complexity too high"
    ...
    config = UnifiedRunConfig(
        prompt="Create an overly complex system (this will fail constitutional validation)",  # noqa: E501
