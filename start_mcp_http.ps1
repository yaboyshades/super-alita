# Start Super Alita MCP Server via HTTP/SSE
$env:MCP_TRANSPORT = "sse"
$env:MCP_PORT = "8001"
$env:MCP_HOST = "0.0.0.0"
$env:MCP_ALLOW_NO_AUTH = "true"
$env:MCP_SERVER_NAME = "Super Alita MCP Server"

Write-Host "Starting Super Alita MCP Server on http://localhost:8001"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAnfu6fqVF8FM01
# HOPAq1ZM3cxkTxML2PuO5DbvLvEcC6CCFRswggHdMIIBRqADAgECAhB1LVe8LkJa
...
# MQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgrbtkTmTQHxn2nnAJTcZw
# cTtHL2CINH5h2pW1MnOPFpEwDQYJKoZIhvcNAQEBBQAEgYBehzrv3C2UChHJ1WAS
# Mnt8wdmWHnPCCMRCa/zbwqbegd9vLhisJLN+OmV9oLeoWXqa2QpAWGt5HcCgQ3qR
# 864fy/iT/pEEic5KY9m4xBXCyrS1Hh0tZvQYtJdZg0Cn2MyPM4H7CMiZMv8vpK+Z
# uPbwRClLx9apR9zg0SgUIMkBM6GCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIB
...
# MjgxODUwMTZaMC8GCSqGSIb3DQEJBDEiBCBLIYyX2R902x5wn8AIfeMb188A4VSm
# 0GOe6gtCz5OmHDANBgkqhkiG9w0BAQEFAASCAgBZhsfAIIQAUhi06yR+2gyuaizy
# Bp1qKOYxh3HYqO4TFluL1taJxGZNnN+kUItyjB0NNeyQ8h1iq26GqtTv1ldDrTXA
# NJAHDBJekql753fvwVvi5D0zutVS/R6XgRgHKYH3Tc5eRj/sZTcL7DaPq1++PaqD
# FCENVE83HyxBJpXgPhqFiKEq/2dSoDAgGWeV8BLKYTxQiHSVzfHnKVMxImjQoIYz
# sy8vH11VIL3u2bcGjkr0HbWgU7K+Ml1XJdN6CwSLJCWRRNTtQ02TatYeS0PV+tBa
# 91515qFtzfch7/MpjJzX4CZwyT4chBnz0w/mI1omNyCOeyv9pDX/0z/bIXURSshl
# 4Hg8KNCE8Bgpi1tqdGCaPZgSjNZ5jpNIa6E6RxurFwZs4DfIu5TZvFM5qPVActtt
# Dd/ud+5C+XeLdGjXwuJXAgF7wyhxU7t4V7psPiNNIhrpjVEwbFIP+LXxdNTjzCu8
# aW7Vg0vjiQFpYBaUraoWyGaQvgL4GAcDLoxHdqvpHsuVBiwA+vl/9BhlJWVj+IHG
# Dhkblh/lYZwmDVPoQSBiC0/8/wHahh/aLFQVdG2gADun5iB2FnCfYN6tE5sHsNPd
# ormsSKcB2bxSi7gCrxc5LV7RlukWWOjRbUOvwm1044x7ohgALA+FnePIHnUzb5E1
# J2D7BnuNVxLzNjHw7w==
