...
def create_sarif_report(
                    ...
                    "driver": {
                        ...
                        "rules": [
                            ...
                            },
                            {
                                ...
                                "shortDescription": {
                                    "text": (
                                        "Function postcondition violated"
                                    )
                                },
                                "fullDescription": {
                                    "text": (
    ...
    for change in signature_changes:
        ...
        rule_id = (
            "api-drift/breaking" if change_type == "breaking" 
    ...
    for violation in contract_violations:
        ...
        sarif["runs"][0]["results"].append({
            ...
            "message": {
                "text": (
                    f"Contract violation in {func}: {desc}"
                )
            },
            "locations": [
                {
    ...
    for issue in semver_issues:
        ...
        rule_id = (
            "api-drift/breaking" if issue.get("severity") == "error" 
            else "api-drift/additive"
        )
        sarif["runs"][0]["results"].append({
            "ruleId": rule_id,
...
def generate_pr_comment(
    ...
    if signature_changes:
        comment.append(
            "- Verify API changes align with specification updates"
        )
