...
- Article II - Test-First Development: 1 item(s) pending to satisfy Article II - Test-First Development. (evidence: specs\047-test-constitutional-feature\next_steps.yaml#test_first)
- Article IV - Integration-First Testing: 1 item(s) pending to satisfy Article IV - Integration-First Testing. (evidence: specs\047-test-constitutional-feature\next_steps.yaml#integration_first)

### Command Checklist
1. Run /plan 047 once clarifications are resolved
2. Invoke /tasks 047 after the plan passes constitutional checks
